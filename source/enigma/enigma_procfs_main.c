...
struct ProcStructure_s enigmaProc[] =
{
	...
	//getBoxType
	{cProcEntry, "enigma/machinebuild", ENIGMA_PROC_PERMISSION, get_enigma_machinebuild, NULL, NULL, ""},
	//getMachineBuild
	...
	//getHaveSCART
	{cProcEntry, "enigma/scartyuv", ENIGMA_PROC_PERMISSION, get_enigma_scartyuv, NULL, NULL, ""},
	//getHaveSCARTYUV
	...
	//getImageType
	{cProcEntry, "enigma/driversdate", ENIGMA_PROC_PERMISSION, get_enigma_driversdate, NULL, NULL, ""},
	//getDriverDate
...
void enigma_kernel_info(void)
{
	...
	printk(KERN_INFO "scartyuv=@HAVE_SCART_YUV@\n");
